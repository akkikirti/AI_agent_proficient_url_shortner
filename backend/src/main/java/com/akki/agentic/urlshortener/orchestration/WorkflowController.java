...
public class WorkflowController {
	...
	private final OrchestrationSecurity orchestrationSecurity;

	public WorkflowController(WorkflowService workflowService, OrchestrationSecurity orchestrationSecurity) {
		this.workflowService = workflowService;
		this.orchestrationSecurity = orchestrationSecurity;
	}
	...
	@PostMapping
	public ResponseEntity<WorkflowState> createWorkflow(
		@Valid @RequestBody CreateWorkflowRequest request,
		@RequestHeader(value = "X-Orchestrator-Token", required = false) String adminToken
	) {
		orchestrationSecurity.requireAdminToken(adminToken);
	...
	public WorkflowState executeWorkflow(
	...
	public WorkflowState replan(
		@PathVariable String workflowId,
		@RequestBody(required = false) ReplanWorkflowRequest request,
		@RequestHeader(value = "X-Orchestrator-Token", required = false) String adminToken
	) {
		orchestrationSecurity.requireAdminToken(adminToken);
